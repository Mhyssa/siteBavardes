...
<div class="col-lg-12 pt-5 pb-5">
    <div class="col-lg-3 text-center float-left">
           ...
           <br>
           <a href="https://www.youtube.com/channel/UCytIqXqtZlAPhZ53_wMMsRQ" class="col-lg-12">Roxaane</a>
    </div>
...
<div class="col-lg-12">
    <div class="col-lg-3 text-center float-left">
           ...
           <br>
           <a href="https://www.instagram.com/mekiasmusic/"  class="col-lg-12">Mekias</a> 
    </div>
    ...
    <div class="col-lg-3 text-center float-left">
          ...
          <br>
          <a href="https://soundcloud.com/queen-of-my-living-room?fbclid=IwAR0e_g1tIwv2zMaLgkEGhdwYUI7mHR4ezSA1BzmL19Z3zKUJ5Z_9Hj1mwOM"> Van Campo</a>
    </div>
    <div class="col-lg-3 text-center float-left">
          <img src="assets/img/artistes/louiz.jpg" class="Artiste" alt="">
          <br>
          <a href="https://www.youtube.com/user/louiiz07/"  class="col-lg-12"> Louiz'</a> 
    </div>
    <div class="col-lg-3 text-center float-left">
...
<div class="col-lg-12 pt-5 pb-5">
    <div class="col-lg-3 text-center float-left">
           ...
           <br>
           <a href="https://www.instagram.com/bali.dou/"  class="col-lg-12">Bali Dou</a> 
    </div>
    ...
    <div class="col-lg-3 text-center float-left">
          ...
          <br>
          <a href="https://soundcloud.com/manopolosound"  class="col-lg-12">Manopolo</a> 
    </div>
    <div class="col-lg-3 text-center float-left">
          <img src="assets/img/artistes/naoo.PNG" class="Artiste" alt="Naoo">
          <br>
          <a href="https://www.instagram.com/naomi_ankh/"  class="col-lg-12">Naoo</a> 

    </div>
    <div class="col-lg-3 text-center float-left">
          <img src="assets/img/artistes/pinkmoloko.jpg" class="Artiste" alt="Pinkmoloko">   
          <br>       
          <a href="https://soundcloud.com/pinkmoloko"  class="col-lg-12">Pinkmoloko</a> 
    </div>
</div>
...
<div class="col-lg-12  pb-5">
    <div class="col-lg-3 text-center float-left">
           ...
           <br>
           <a href="https://www.youtube.com/watch?v=pwN2LvwVxn0"> Flèche Love</a>
    </div>
    ...
    <div class="col-lg-3 text-center float-left">
          ...
          <br>
          <a href="https://www.youtube.com/channel/UCAvggLZTjgwcZYTtFy8ue9g">Pumpkin</a> 
    </div>
    <div class="col-lg-3 text-center float-left">
          <img src="assets\img\artistes\queen_ci.jpg" class="Artiste" alt=" Quenn Ci">
          <br>
          <a href="https://soundcloud.com/queenciselections"> Quenn Ci </a>
...
<div class="col-lg-12  pb-5">
    <div class="col-lg-3 text-center float-left">
           ...
           <br>
           <a href="http://audreyvernon.com/"> Audrey Vernon</a>
    </div>
