<!-- *****************************************************************************     
permet d'afficher la liste des affiches 
****************************************************************************** -->
...
<h1 style="color:blue;">Affiches</h1>
...
{ ?>
     ...
     <div> 
          <?php  echo $row->aff_nom; ?>
          <a href="detail.php?sta_id=<?php echo $row->aff_id ?>">    détail</a>
          <a href="modif.php?sta_id=<?php echo $row->aff_id ?>">    modifier</a>
          <a href="script_delete.php?sta_id=<?php echo $row->aff_id  ?>" onclick="Suppression();">    supprimer</a>
     </div>
...
<div>
     nom affiche
     <a href="detail.php?aff_id=X       ">    détail</a>
     <a href="modif.php?aff_id=X">    modifier</a>
     <a href="script_delete.php?aff_id=X" onclick="Suppression();">    supprimer</a>
</div>
