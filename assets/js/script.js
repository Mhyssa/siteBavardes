// dÃ©claration de variable qui serviront Ã  la rÃ©cupÃ©ration de la valeur des champs de saisie
...
// dÃ©finition du ciblage pour l'affichage du message d'erreur
...
// dÃ©finition des conditions de validation des champs de saisie
var mailValid = /[a-z0-9._%+-]+@[a-z0-9.-]+.[a-z]{2,4}/;
var nameValid = /^[a-zA-ZÃ©Ã¨Ã®Ã¯Ã‰ÃˆÃŽÃ]+([-'\s][a-zA-ZÃ©Ã¨Ã®Ã¯Ã‰ÃˆÃŽÃ][a_zÃ©Ã¨ÃªÃ Ã§Ã©Ã¨Ã®Ã¯]+)?$/;
...
// dÃ©claration des fonctions vÃ©rifiant les champs de saisie du formulaire
    // vérification du champ prenom
    function prenomCheck() {
        if (prenom.validity.valueMissing) {
            event.preventDefault()
            missPrenom.textContent = 'Renseigner ce champ / complete this field';
            missPrenom.style.color = 'red';
        } else if (nameValid.test(prenom.value) == false) {
            event.preventDefault();
            missPrenom.textContent = 'Format incorrect / wrong format';
    ...
    function nomCheck(){
        if (nom.validity.valueMissing) {
            ...
            event.preventDefault();
            missNom.textContent = 'Format incorrect / wrong format';
    ...
    function mailCheck(){
        if(mail.validity.valueMissing) {
            event.preventDefault()
            missMail.textContent = 'Renseigner ce champ / complete this field';
            missMail.style.color = 'red';
        } else if(mailValid.test(mail.value) == false) {
            event.preventDefault();
            missMail.textContent = 'Format incorrect / wrong format (ex / e.g mail@example.fr)';
    ...
    function phoneCheck(){
        if(phone.validity.valueMissing){
            event.preventDefault()
            missPhone.textContent = 'Renseigner ce champ / complete this field';
            missPhone.style.color = 'red';
        } else if(phoneValid.test(phone.value) == false) {
            event.preventDefault();
            missPhone.textContent = 'Format incorrect / wrong format (ex / e.g 0102030405)';
    ...
    // vÃ©rification du champ mot de passe
    function pswCheck(){
        if(psw.validity.valueMissing){
            event.preventDefault()
            missPsw.textContent = 'Renseigner ce champ / complete this field';
    ...
    // vÃ©rification du champ mot de passe (Ã  confirmer)
    function confpswCheck(){
        if(confpsw.validity.valueMissing){
            event.preventDefault()
            missConfPsw.textContent = 'Renseigner ce champ / complete this field';
    ...
    // vÃ©rification du champ captcha
    function captchaCheck(){
        if(captcha.validity.valueMissing){
            event.preventDefault()
            missCaptcha.textContent = 'Renseigner ce champ / complete this field';
