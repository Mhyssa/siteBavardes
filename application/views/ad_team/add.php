    ...
    <div class="row">
        ...
        <?php echo form_open_multipart() ;?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="team_description" class="form-control" id="team_description" cols="30" rows="10" placeholder="<?php echo $team['team_description']; ?>" value="<?php echo !empty($team['team_description'])?$team['team_description']:''; ?>"></textarea>
