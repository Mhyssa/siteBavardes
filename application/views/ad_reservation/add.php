<div class="container">
    <h1 class="text-center">Ajout d'une Reservation</h1>
    <hr>
    ...
    <div class="row d-flex justify-content-center">
        ...
        <?php echo form_open('Reservation/add_reservation'); ?>
        ...
        <div class="form-group ">
            ...
            <select name="poster_id">
                ...
                <?php foreach ($posters as $poster) {
                    if (set_value('poster_id') == $poster->poster_id) { ?>
