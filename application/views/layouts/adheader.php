                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-white mb-4" id="navBar">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <a class="navbar-brand pl-3 pr-5"
                               href="<?php echo base_url() . 'index.php/users/ad_index'; ?>">
                                <img src="<?php echo base_url(); ?>assets/img/logo.png" width="" height="80"
                            ...
                            <ul class="navbar-nav">
                                ...
                                <?php if ($ma_pages == 'ad_index_event') { ?>
                                    ...
                                    <li class="nav-item active pr-4 pl-4 ">
                                        <a class="nav-link text-center"
                                           href="<?php echo base_url() . 'index.php/event/ad_index' ?>">Evenements<span
                                ...
                                <?php if ($ma_pages == 'ad_index_people') { ?>
                                    <li class="nav-item active pr-4  pl-4">
                                        <a class="nav-link text-center"
                                           href="<?php echo base_url() . 'index.php/people/ad_index' ?>">Artistes/Intervenant.es</a>
                                    </li>
                                <?php } else { ?>
                                    <li class="nav-item pr-4  pl-4">
                                        <a class="nav-link text-center"
                                ...
                                if ($ma_pages == 'ad_index_team') { ?>
                                    <li class="nav-item active pr-4  pl-4">
                                        <a class="nav-link text-center"
                                           href="<?php echo base_url() . 'index.php/team/ad_index' ?>">Equipe</a>
                                    </li>
                                    <?php
                                } else { ?>
                                ...
                                <?php if ($ma_pages == 'ad_index_presse') { ?>
                                    <li class="nav-item active pr-4  pl-4">
                                        <a class="nav-link text-center"
                                           href="<?php echo base_url() . 'index.php/about/ad_index' ?>">Presse</a>
                                    </li>
                                <?php } else { ?>
                                    <li class="nav-item pr-4  pl-4">
                                        <a class="nav-link text-center"
                                ...
                                <?php if ($ma_pages == 'ad_index_collab') { ?>
                                    <li class="nav-item active pr-4  pl-4">
                                        <a class="nav-link text-center"
                                           href="<?php echo base_url() . 'index.php/collab/ad_index' ?>">Collaborations</a>
                                    </li>
                                <?php } else { ?>
                                    <li class="nav-item pr-4  pl-4">
                                        <a class="nav-link text-center"
                                ...
                                <?php if ($ma_pages == 'ad_index_podcast') { ?>
                                    <li class="nav-item active pr-4  pl-4">
                                        <a class="nav-link text-center"
                                           href="<?php echo base_url() . 'index.php/podcast/ad_index' ?>">podcasts</a>
                                    </li>
                                <?php } else { ?>
                                    <li class="nav-item pr-4  pl-4">
                                        <a class="nav-link text-center"
                                ...
                                <?php if ($ma_pages == 'ad_index_admin') { ?>
                                    ...
                                    <li class="nav-item active pr-4 pl-4 ">
                                        <a class="nav-link text-center"
                                           href="<?php echo base_url() . 'index.php/users/ad_index' ?>">Utilisateurs</a>
                                    </li>
                                <?php } else { ?>
                                ...
                                <?php if ($ma_pages == 'ad_index_posters') { ?>

                                    <li class="nav-item active pr-4 pl-4 ">
                                        <a class="nav-link text-center"
                                           href="<?php echo base_url() . 'index.php/posters/ad_index' ?>">Affiches</a>
                                    </li>
                                <?php } else { ?>
                                ...
                                <?php if ($ma_pages == 'ad_index_library') { ?>

                                    <li class="nav-item active pr-4 pl-4 ">
                                        <a class="nav-link text-center"
                                           href="<?php echo base_url() . 'index.php/library/ad_index' ?>">Bibliotheque</a>
                                    </li>
                                <?php } else { ?>
                                ...
                                <li class="nav-item pr-4  pl-4">
                                    <a class="nav-link text-center"
                                       href="<?php echo base_url() . 'index.php/users/logout'; ?>">Déconnexion</a>
                                </li>
