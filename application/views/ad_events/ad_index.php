      ...
      <div class="col-12 col-md-12">
          ...
          <form method="post">
              <div class="input-group mb-3">
                  <input type="text" name="searchKeywordAdmin" class="form-control" placeholder="Nom d'un évènement"
          ...
          <div class="float-right">
              <a href="<?php echo base_url(); ?>index.php/event/add_event" class="btn btn-success btn-sm"><i
              ...
              <tbody>
                ...
                ?>
                  <tr>
                      ...
                      <td>
                          <a href="<?php echo base_url().'index.php/event/ad_view_event/'.$row['event_id']; ?>"
                              class="btn btn-sm btn-primary"><i class="fas fa-asterisk"></i></a>
                          <a href="<?php echo base_url().'index.php/event/edit_event/'.$row['event_id']; ?>"
                              class="btn btn-sm btn-warning"><i class="fas fa-pencil-alt"></i></a>
                          <a href="<?php echo base_url().'index.php/event/delete_event/'.$row['event_id']; ?>"
                              class="btn btn-sm btn-danger"
                              onclick="return confirm('Voulez vous vraiment supprimer cette donnée?')"><i
                                  class="far fa-calendar-minus"></i></a>
                      </td>
                  </tr>
                  <?php } }else{ ?>
                  <tr>
