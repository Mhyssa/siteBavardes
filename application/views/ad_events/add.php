    ...
    <div class="row">
        ...
        <?php echo form_open_multipart() ;?>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <input type="radio" name="event_inscription" id="event_inscription" value="Sur Inscription">Oui <br>
                            <input type="radio" name="event_inscription" id="event_inscription" value="Sans Inscription">Non
                        </div>
                        <div class="col-4">
                            <label for="event_non_mix">Non mixité choisie : </label> <br>
                            <input type="radio" name="event_non_mix" id="event_non_mix" value="Non Mixité Choisie">Oui <br>
                            <input type="radio" name="event_non_mix" id="event_non_mix" value="Pour Tout le Monde">Non
                        </div> 
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="event_description" class="form-control" id="event_description" cols="30" rows="10" value="<?php echo !empty($events['event_description'])?$events['event_description']:''; ?>"></textarea>
                </div>
                ...
                <div class="form-group">
                    <a href="<?php echo base_url().'index.php/event/ad_index'; ?>" class="btn btn-sm btn-secondary"><i class="fas fa-backspace"></i></a>
                    <input type="submit" name="event_add" class="btn btn-sm btn-success" value="Ajouter">
                </div>
