    ...
    <div class="row">
        ...
        <?php echo form_open_multipart() ;?>
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            ...
                            <input type="radio" name="people_status" id="people_status" value="Artiste"> Artiste  
                            <input type="radio" name="people_status" id="people_status" value="Intervenant.e"> Intervenant.e
                ...
                <div class="form-group">
                    ...
                    <input type="submit" name="people_add" class="btn btn-success btn-sm" value="Ajouter">
                </div>
