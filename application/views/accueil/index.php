...
<div class="container-fluid">
  ...
  <div class="jumbotron paral paralsec">
    ...
    <div class="col-lg-12 col-sm-12">
      <a class="button btn-block col-lg-12 col-sm-12" href="<?php echo base_url().'about'; ?>" role="button"><div class="text-center">qui sommes nous ?</div></a>
      <blockquote class="d-flex align-items-center lead sur-noir text-center m-5 p-5">" Les bavardes, c'est un collectif lesbien, bi, trans, queer et hétéro féministe engagé pour la visibilité de toutes les femmes, au travers d’espaces et d’actions culturelles et artistiques, ouvert à toutes et tous, visant à agir, se rencontrer, s’interroger et faire la fête. Radio, atelier, débat, cinéma, soirée… Retrouvons-nous, interrogeons-nous et émancipons-nous ! " 
        <br> [...]</blockquote>
      <a class="button btn-block col-lg-12 col-sm-12" href="<?php echo base_url().'team';?>" role="button"><div class="text-center">&#10150;qui sont-elles ?</div></a>
</div>
  ...
  <div class="jumbotron paral paralsec1">
    ...
    <p class="lead">
      <a class="mt-5 button" href="<?php echo base_url().'podcast'?>" role="button">et L'ensemble de Nos Podcasts ici !</a>
    </p>
  </div>
  ...
  <div class="jumbotron paral paralsec2">
    ...
    <div>
      ...
      <p><a class="sur-noir" href="<?php echo base_url().'presse';?>">&#10150; Consulte les 30 articles parlant de nous au fil de notre histoire !</a></p>
    </div>
  </div>
  ...
  <div class="jumbotron paral paralsec3">
    ...
    <p><a class="button2" href="<?php echo base_url().'people';?>" role="button"> &#10150; Lumiere sur ces femmes incroyables qui ont croisées nos routes au cours de nos évènements</a></p>
  </div>
