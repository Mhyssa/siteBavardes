 ...
 public function delete_admin($id){
    ...
    public function account($lang = ''){
        ...
        if($this->isUserLoggedIn){
            ...
            // navbar
            $data['account_navlink1'] = $this->lang->line('account_navlink1');
            $data['account_navlink2'] = $this->lang->line('account_navlink2');
            $data['account_navlink3'] = $this->lang->line('account_navlink3');
            $data['account_navlink4'] = $this->lang->line('account_navlink4');
            $data['account_poster_ad'] = $this->lang->line('account_poster_ad');
            $data['account_poster_book'] = $this->lang->line('account_poster_book');
